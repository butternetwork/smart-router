...
async function main() {
  const [total1,_,gasCostInUSD1] = await findBestRouter(56,WBNB_BNB,USDC_BNB,amount)
...
async function findBestRouter(chainId: number, tokenIn: Token, tokenOut: Token, amount: string) {
  switch (chainId) {
    case 1: //fork_eth
